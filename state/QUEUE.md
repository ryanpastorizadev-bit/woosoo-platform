...
| P2 | INFRA-CASE-004 | woosoo-platform | Script flow unification — prune check.sh duplicates, fix stale production-docker.md (setup-woosoo-env ref), document two WSL2 paths. Case: `infra-case-004-script-flow-unification.md` | 2 | none | queued | — |
