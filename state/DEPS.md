...
| DEP-004 | woosoo-nexus | tablet-ordering-pwa | NEX-CASE-013 ships `order.details.updated` broadcast on `orders.{order_id}` (POS-detail live sync) per `contracts/websocket-events.contract.md` | confirmed | 6 new tests (20 assertions) green; 438/438 full suite; OrderDetailsUpdated event on orders.{order_id} + admin.orders; pos:consume-order-detail-events registered. Executioner APPROVED 2026-06-01. | TAB-CASE-010 | 2026-06-01 | TAB-CASE-010 now unblocked |
