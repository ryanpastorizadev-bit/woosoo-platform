...
|---|---|---|---|---|---|---|
| NEX-CASE-015 | woosoo-nexus | 2026-06-07 | `StoreDeviceOrderRequest` intent-only strip; 447/447 tests PASS. Merged PR #178 (`f3f79d8` on `dev`). Contract + AI_ONBOARDING docs synced 2026-06-07. | APPROVED | none | Docs #156 paths fixed in `AI_ONBOARDING.md`. |
