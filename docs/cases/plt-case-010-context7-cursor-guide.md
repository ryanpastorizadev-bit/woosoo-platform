...
<!-- 2026-06-08: status reverted APPROVED -> IN_PROGRESS. APPROVED is an Executioner verdict;
     it must not be self-claimed before the Executioner gate runs. Only the operator-driven
     Executioner phase may set APPROVED/COMPLETE. -->
