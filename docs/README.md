...
- [woosoo-nexus/docs/software-development/](https://github.com/tech-artificer/woosoo-nexus/tree/main/docs/software-development) — software development documentation package: process, product, and user documentation
